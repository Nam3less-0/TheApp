...
interface ExposedPanelProps {
  children: ReactNode;
  className?: string;
}

export default function ExposedPanel({ children, className = '' }: ExposedPanelProps) {
  return (
    <div
...
export function ExposedPageWrap({ children }: { children: ReactNode }) {
  return (
